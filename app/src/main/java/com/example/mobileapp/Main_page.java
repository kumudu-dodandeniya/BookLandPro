                ...
                if(dataSnapshot.child("Users").child(phonenumber).exists()){
                    ...
                    if(usersData.getPhonenumber().equals(phonenumber)){
                        ...
                        if(usersData.getPassword().equals(password)){
                            Toast.makeText(Main_page.this, "logged in Successfully", Toast.LENGTH_SHORT).show();
                            loadingBar.dismiss();
                            ...
                            loadingBar.dismiss();
                            Toast.makeText(Main_page.this, "Password is incorrect", Toast.LENGTH_SHORT).show();
                        }

                    }
                }
                else{
                    Toast.makeText(Main_page.this, "Account with this" +phonenumber +"do not exists", Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                }
            }
